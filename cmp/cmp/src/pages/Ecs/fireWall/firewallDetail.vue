<template>
    <div class="ecs-detail">
        <div class="header">
            <span class="title">云主机 / 防火墙 / administer</span>
            ...
            <div class="base-info">
                ...
                <div class="content">
                    <div class="row">
                        ...
                        <span class="info">administer</span>
                    </div>
                    <div class="row">
        ...
        <div class="operating-wrapper">
            <div class="operate-tab">
                <router-link to="/firewallDetail/childVPC" tag="span" class="operate-tab-item">
                    关联VPC
                </router-link>
                <router-link to="/firewallDetail/childACL" tag="span"  class="operate-tab-item">
                    ACL管理
                </router-link>
            </div>
